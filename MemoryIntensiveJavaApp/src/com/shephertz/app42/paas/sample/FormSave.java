...
public class FormSave extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		String usage = new MemoryTask().Info();
		System.out.println("Usage: " + usage);
	    out.print("<!doctype html><html><head><meta charset='utf-8'><title>App42 CPU-Intensive App</title><body><h2>CPU Usage: "+usage+" </h2></body></html>");
	}
