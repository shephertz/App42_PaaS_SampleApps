...
5. Create service (mysql)
6. Deploy a Ruby on Rails application

1. Sign up

Sign up OR login for a App42PaaS account, if you don’t already have account.
...
Download and install Ruby Installer for Windows and set ruby to your path to access App42 from command prompt.
...
4. Setup infrastructure for required environment(Rails 4.0 + Mysql)
...
Create or change the production group to include mysql
